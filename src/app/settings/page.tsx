    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col p-5">
          ...
          <label className="relative mx-auto bg-white rounded-md font-bold w-36 h-6 text-center" for='files'>Change Photo</label>
        </div>

        <div className="bg-white p-5 rounded-xl h-screen max-w-screen-lg overflow-hidden">
          <h1 className="text-4xl mt-30 mb-10 font-bold">Account Information</h1>
          <div className="mb-10">
